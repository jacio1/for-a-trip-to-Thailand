...
export default function Account({ setNewEmail, setNewLogin, setNewPassword, openTerms }: AccountProps) {
  ...
  return (
    <form className="min-w-full h-full p-3 flex gap-3 flex-col justify-center">
      ...
      <p className="fs-s fw-400 cursor-pointer" style={{color: 'var(--link-color)'}} onClick={openTerms}>By continuing, you agree to our latest version of the public offer</p>
    </form>
  );
}
